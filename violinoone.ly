...
violinoone = {
  ...
  \repeat volta 2 {
    \global
    g8.  ( \mark \markup \bold {MENUETTO.} c'16) ees'2( f'4\sf)
  ...
  \repeat volta 2 {
    r4
    R2. R2. R2. e''2.\sf f''2( g''4\sf) f''2( g''4\sf) f''2( g''4\sf) f''4 r aes'8.\p( des''16)
    f''2_\markup { \italic "cresc." }( ges''4 g''! aes'' a'' bes'' b'' c''' des''' ees'''8 des''' c''' bes''!)
    aes''2( ges''4\sf) f''2( ges''4\sf) f''2( ges''4\sf) f''2. ~ f''2.
    \afterGrace ees''2. ( { d''16 ees'') }
  ...
  \alternative { { c''4 r } { c''4 \bar "" r \partial 4 r4 \bar "||" } }
  \break
  ...
  \repeat volta 2 {
    ...
    \tupletSpan 4
    \tuplet 3/2 {
      c'8\p  [ \mark \markup \bold { "TRIO." } c' c'] ees'[ ees' ees'] aes'[ aes' aes']
  ...
  \tupletSpan 4
  \tuplet 3/2 {
    g8^\p[ g g] bes[ bes bes] ees'[ ees' ees']
    g'[ g' g'] ees'[ ees' ees'] bes[ bes bes]
    ...
    \ottava #1 bes'''[ bes''' bes'''] des''''[ des'''' des''''] des''''[ des'''' des'''']
  }
  des''''2.^\fermata \ottava #0
  r8 des'''8\p ([ c''' bes'' aes'' g'']) aes''4.( ees''8 c''4\staccato) f''4.( des''8 bes'4\staccato)
  <<
    { aes'2( c''8 bes') } \\
    { \override NoteHead.font-size = #-2 \stemUp s4 bes'16[ aes' g' aes'] s4 }
  >> aes'4 r r
  <<
    { aes2_\markup { \italic "decresc." }( c'8 bes) } \\
    { \override NoteHead.font-size = #-2 \stemUp s4 bes16[ aes g aes] s4 }
  >> aes4 r r
  f'4\pp r r ees' r r d' r  r r r \textEndMark  \markup \italic "Menuetto da capo"  \bar "||"
}