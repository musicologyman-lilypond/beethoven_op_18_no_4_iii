...
cello = {
  ...
  \global
  \repeat volta 2 {
    r4 c,4\staccato c\staccato bes,\sf\staccato ees ees, c\sf g, g( c'\sf a bes) r4
    f,4\staccato f\staccato g\sf\staccato aes aes, f\sf( g,) g\staccato g\staccato c4 r
  }

  \partial 4
  \repeat volta 2 {
    r4 c4 c' c' c' c' c' c' c' c' c'\sf c' c' f c' c\sf f c' c\sf f c' c\sf f r r
  ...
  r4 ees,_\markup { \italic "decresc." }( e, f,) r r f\pp r r fis r r g r r r r \bar "||"
}