...
violinotwo = {
  ...
  \global
  \repeat volta 2 {
    r4 c'2( d'4\sf) ees'2 ees'4\sf ees'2 ges'4\sf ~ ges'4( f') r
  ...
  \repeat volta 2 {
    \break
    g8.\f( c'16) e'2( f'4 fis' g' aes' a' bes' c'')
  ...
  r4 aes_\markup { \italic "decresc." }( g aes) r r d'\pp r r c' r r b r r r r \bar "||"
}