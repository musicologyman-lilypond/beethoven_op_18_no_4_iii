...
viola = {
  ...
  \global
  \repeat volta 2 {
    r4 g2( bes4\sf) bes2( aes4\sf) g4 g'( a'\sf c'' bes') r
    aes2( bes4\sf) c'4\staccato c\staccato d'\sf\staccato( ees') ees'\staccato d'\staccato c'4 r
  }

  \partial 4
  \repeat volta 2 {
    r4 c'2\f d'4( dis' e' f' fis' g' aes') bes'2\sf( aes'8 g') f'2( e'4\sf) f'2( e'4\sf) f'2( e'4\sf) f'4 r r
  ...
  r4 c_\markup { \italic "decresc." }( des c) r r aes4\pp r r a r r b r r r r \bar "||"
